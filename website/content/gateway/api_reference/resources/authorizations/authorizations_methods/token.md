...
* `token[scof]`: Mastercard Digital Enablement Service (MDES) for Merchants (SCOF)
...
{{% description_term %}}token[scof][rcai] {{% regex %}}[:base64:]{1..150}{{% /regex %}}{{% /description_term %}}
...
{{% description_term %}}token[scof][3dsecure][v2] {{% regex %}}dictionary{{% /regex %}}{{% /description_term %}}
