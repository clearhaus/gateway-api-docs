...
<dl class="dl-horizontal">
  ...
  <dt>recurring</dt>
  <dd>
    Deprecated! Please use <code>series[]</code>. <br />
    (true|false) <br />
    <i>Optional</i> <br />
  ...
  <dd>
    [:uuidv4:] <br />
    <i>Optional</i> <br />
    Identifier generated by the user.
  </dd>
  <dt>series[type]</dt>
  <dd>
    (recurring|instalment|unscheduled) <br />
    <i>Optional</i> <br />
    The type of transaction series.
  </dd>
...
<p class="alert alert-info">
  <b>Notice:</b> Subscriptions of any kind (including recurring, instalments,
  and unscheduled credential on file) is considered a series of transactions on
  a card. The series connects the different transactions made.
  <br />
</p>
